...
const wasmPath =
  self.WEB4DV_WASM_URL ||
  new URL("web4dv/CODEC.wasm", self.location.origin).href;
...
var ___getTypeName = (Module["___getTypeName"] = function () {
  return (___getTypeName = Module["___getTypeName"] = Module["asm"]["M"]).apply(
    null,
    arguments,
  );
});
...
var dynCall_viijii = (Module["dynCall_viijii"] = function () {
  return (dynCall_viijii = Module["dynCall_viijii"] = Module["asm"]["P"]).apply(
    null,
    arguments,
  );
});
...
var dynCall_iiiiij = (Module["dynCall_iiiiij"] = function () {
  return (dynCall_iiiiij = Module["dynCall_iiiiij"] = Module["asm"]["R"]).apply(
    null,
    arguments,
  );
});
